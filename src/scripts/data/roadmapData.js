...
// Get roadmap steps (used in multiple components)
...
export const getRoadmapDetails = async (id) => {
  ...
  if (!id || !allRoadmaps[id])
    return allRoadmaps["1"];
...
// Get detailed step data for RoadmapView.vue
export const getDetailedStep = async (stepId) => {
  ...
  return stepId ? steps[stepId] : steps
}

// Get CompletionView.vue data
