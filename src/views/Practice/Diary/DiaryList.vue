...
import { getPagedDiaryNotes, deleteDiaryNote } from '@/scripts/api/services/diaryNoteService';
...
export default {
    ...
    methods: {
        ...
        viewEntry(diaryId, diaryTitle) {
            this.$router.push({ name: 'DiaryWriting', params: { id: diaryId, title: diaryTitle } });
        },
