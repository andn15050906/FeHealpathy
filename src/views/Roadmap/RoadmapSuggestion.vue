                ...
                <template v-if="!skippedIssue">
                  <v-stepper-window-item :value="2">
                    <v-card-text>
                      ...
                      <h3 class="text-h6 mb-4"
                        >Vấn đề hiện tại của bạn là gì?</h3
                      >
                  ...
                  <v-stepper-window-item :value="5">
                    <v-card-text>
                      ...
                      <v-radio-group v-model="answers.related">
                        ...
                        ></v-radio>
                        <v-radio
                          label="Bạn bè / người yêu"
                          value="friend"
                        ></v-radio>
                        <v-radio
                          label="Sếp / đồng nghiệp"
                          value="boss"
                        ></v-radio>
                        <v-radio
                          label="Chính bản thân mình"
                          value="myself"
                        ></v-radio>
        ...
        <div v-if="showResults">
          <div class="result-section">
            ...
            <v-card v-if="isNormalMentalHealth" class="mb-6 normal-mental-card">
              ...
              <v-card-text>
                <p class="text-body-1"
                  >Dựa trên những chia sẻ của bạn, chúng tôi nhận thấy tâm lý
        ...
        <v-dialog v-model="showPaymentSuccess" max-width="400">
          <v-card>
            <v-card-text class="text-center pa-6">
              ...
              <p class="mb-4"
                >Cảm ơn bạn đã thanh toán. Bạn đã có thể truy cập đầy đủ nội
                dung của lộ trình.</p
              >
            ...
            <v-card-text class="pt-4">
              <v-alert color="info" variant="tonal" border="start" class="mb-4">
                <div class="text-subtitle-1 font-weight-medium mb-2"
                  >Dựa vào các câu trả lời của bạn, chúng tôi xác định:</div
                >
