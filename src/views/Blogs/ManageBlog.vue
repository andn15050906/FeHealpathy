      ...
      <div class="blog-list">
        <div class="blog-item" v-for="blog in blogs" :key="blog.id">
          ...
          <div class="blog-details">
            ...
            <p class="blog-date">Ngày đăng: {{ formatDate(blog.date) }}</p>
            <div class="actions">
    ...
    data() {
      return {
        blogs: [
          {
            id: 1,
            title: "Hướng dẫn yoga blog 1",
            image: "https://via.placeholder.com/150",
            date: "2025-01-10",
          },
          {
            id: 2,
            title: "Hướng dẫn yoga blog 2",
            image: "https://via.placeholder.com/150",
            date: "2025-01-11",
          },
          {
            id: 3,
            title: "Hướng dẫn yoga blog 3",
            image: "https://via.placeholder.com/150",
            date: "2025-01-12",
          },
          {
            id: 4,
            title: "Hướng dẫn yoga blog 4",
            image: "https://via.placeholder.com/150",
            date: "2025-01-13",
          },
        ],
