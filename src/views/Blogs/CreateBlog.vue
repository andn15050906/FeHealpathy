  ...
  <div class="blog-creation">
    ...
    <form @submit.prevent="submitBlog" class="blog-form">
      ...
      <div class="form-group">
        ...
        <multiselect v-model="selectedKeywords" :options="availableKeywords" :multiple="true" :close-on-select="false"
          :clear-on-select="false" :preserve-search="true" placeholder="Chọn từ khóa" label="name" track-by="name"
      ...
      <div class="sections">
        ...
        <div class="section" v-for="(section, index) in blog.sections" :key="index">
          ...
          <div class="form-group">
            ...
            <input type="file" @change="(e) => handleSectionImageUpload(e, index)" accept="image/*" />
