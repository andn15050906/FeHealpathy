<template>
    <div class="blog-management">
      ...
      <button class="create-blog-btn btn" @click="createBlog">✅ Create Course</button>
    </router-link>
    </div>
      <div class="blog-list">
        <div class="blog-item" v-for="blog in blogs" :key="blog.id">
          ...
          <div class="blog-details">
            ...
            <div class="actions">
              <button class="btn view" @click="viewBlog(blog)">👁️ View</button>
              <button class="btn edit" @click="editBlog(blog)">✏️ Update</button>
